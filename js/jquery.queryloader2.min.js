 ...
 */! function(a) {
	...
	! function(a) {"use strict";
		...
		d.getListeners = function(a) {
			...
			if ("string" === c)
				...
				for (b in d)d.hasOwnProperty(b) && a.test(b) &&
				delete d[b];
			else
				delete this._events;
			return this
	...
	}.call(this), function(a, b) {"use strict";
	...
	}(this, function(a, b, c) {"use strict";
		function d(a, b) {
			for (var c in b)
			a[c] = b[c];
			return a
		...
		g.prototype = new b, g.prototype.options = {}, g.prototype.getImages = function() {
			...
			if (a.isConfirmed)
				return this.confirm(a.isLoaded, "cached was confirmed"),
				void 0;
		...
		var b = "absolute";
		if ("body" == this.parent.element.tagName.toLowerCase())
			b = "fixed";
		else {
		...
		if (this.options = a.extend({}, this.defaultOptions, this.options), this.findImageInElement(this.element), 1 == this.options.deepSearch)
			for (var b = this.$element.find("*:not(script)"), c = 0; c < b.length; c++)
			...
			for (var g = c.split(", "), h = 0; h < g.length; h++)
				if (this.validUrl(g[h]) && this.urlIsNew(g[h])) {
					...
					if (this.isIE() || this.isOpera())
						i = "?rand=" + Math.random(), this.preloadContainer.addImage(g[h] + i);
